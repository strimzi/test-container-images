...
do
    ...
    KAFKA_URL="https://www.apache.org/dyn/mirrors/mirrors.cgi?action=download&filename=https://archive.apache.org/dist/kafka/$KAFKA_VERSION/kafka_$SCALA_VERSION-$KAFKA_VERSION.tgz"
