...
do
    ...
    echo "[INFO] Building images with following setup: DOCKER_VERSION_ARG=$DOCKER_VERSION_ARG, PROJECT_NAME=$PROJECT_NAME, IMAGE_TAG=$CURRENT_TAG, DOCKERFILE_DIR=$DOCKERFILE_DIR"
